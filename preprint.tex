...
\node [shift={(-0.6in,1.1cm)},scale=0.2,opacity=0.4] at (current page.south east)[anchor=south east]{\includegraphics{logoBrocoli}};%
\pagestyle{normal}
...
chou\\term : cultivated plant\\link :
http://data.loterre.fr/ark:/67375/BLH-C3TJ6Q4W-Q\\}
}
